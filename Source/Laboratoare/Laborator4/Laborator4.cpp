...
void Laborator4::Init()
{
...

	{
		...
		mesh->LoadMesh(RESOURCE_PATH::MODELS + "Models", "teapot.obj");
...
void Laborator4::Update(float deltaTimeSeconds)
{
	...
	// draw the reflextion on the mesh
	{
		...
		glm::mat4 modelMatrix = glm::scale(glm::mat4(1), glm::vec3(10.1f));
		...
		loc_texture = shader->GetUniformLocation("total_time");
		glUniform1f(loc_texture, 1.0f + sin(total_time) / 100);
